...
export default function MenuNavegacao() {
  ...
  const icones = [
    ...
    { key: "notificacoes", src: "/images/notificacoes-menu.png",   alt: "Notificações", action: handleToggleNotificacoes, show: tipo === 0 || tipo === 1 },
          ...
          {icones.map((icone) => (
            <button
              ...
              onClick={
                icone.action
                  ? icone.action
                  : () => (icone.key === "logout" ? router.post("/logout") : router.visit(icone.href))
              }
              style={{ background: "none", border: "none", outline: "none", padding: 0, cursor: "pointer", display: "flex", alignItems: "center" }}
            >
